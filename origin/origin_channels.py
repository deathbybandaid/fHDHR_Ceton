...
class OriginChannels():
    ...
    def get_channels(self):
        ...
        for i in range(1,count):
           stations_url = ('http://' + self.fhdhr.config.dict["origin"]["ceton_ip"] + '/view_channel_map.cgi?page=' + str(i) + '&xml=1')
    ...
    def get_channel_stream(self, chandict):
        ...
        if tuned:
            self.fhdhr.logger.info('Initiate streaming channel ' + str(chandict['number'])
